...
export class AppComponent implements OnInit {
  ...
  activateTeoriaMode(){
    this.algoritmoElegido = "None"
    this.teoriaMode = true;
  }
  ...
  getBodyWith(){
    return this.execBodyDimension.width + this.configDimension.width; 
  }
